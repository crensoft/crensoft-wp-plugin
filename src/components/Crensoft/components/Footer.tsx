...
const makeSocialBtn = (icon: any, className: string) => (
          ...
          <Col className={classes.content} xs={12} sm={6}>
            <Row>
              <div className={classes.layout}>
                ...
                <Spacer val={1} />
                <div>
                  {makeSocialBtn('facebook-f', classes.SocialBtn)}
                  {makeSocialBtn('twitter', classes.SocialBtn)}
                  {makeSocialBtn('instagram', classes.SocialBtn)}
                </div>
              </div>
            </Row>
          </Col>
