 ...
 */
registerBlockType("crensoft/privacy", {
  // Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
  title: __("Privacy Page"), // Block title.
  ...
  edit: function(props: any) {
    ...
    return [<BlockControls key="ctrl" />, <PrivacyPage key="content" />];
  },
  ...
  save: function(props: any) {
    ...
    const html = ReactDOM.renderToString(sheets.collect(<PrivacyPage />));
    const css = sheets.toString();
    return (
      <div
        className="wp-block-crensoft-privacy"
        data-css={css}
